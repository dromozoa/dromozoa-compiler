...
assert(uint64(0x0000, 0x000000000000):tostring_hex() == "0x0000000000000000")
assert(uint64(0x0000, 0xFFFFFFFFFFFF):tostring_hex() == "0x0000FFFFFFFFFFFF")
assert(uint64(0xFFFF, 0xFFFFFFFFFFFF):tostring_hex() == "0xFFFFFFFFFFFFFFFF")
assert(uint64(0xDEAD, 0xBEEFFEEDFACE):tostring_hex() == "0xDEADBEEFFEEDFACE")

assert(uint64(0x0000, 0x000000000000):tostring_dec() == "0")
assert(uint64(0x0000, 0xFFFFFFFFFFFF):tostring_dec() == "281474976710655")
assert(uint64(0xFFFF, 0xFFFFFFFFFFFF):tostring_dec() == "18446744073709551615")
